...
export default function HostLayout({
  ...
  const hostNavItems = [
    { href: "/host", label: t("dashboard"), icon: LayoutDashboard },
    { href: "/host/spaces", label: t("mySpaces"), icon: Building2 },
    { href: "/host/bookings", label: t("bookings"), icon: CalendarDays },
    { href: "/host/earnings", label: t("earnings"), icon: DollarSign },
  ];
      ...
      <aside className="w-64 shrink-0 hidden lg:block">
        <div className="sticky top-4 space-y-2">
          <div className="p-4 bg-gray-50 rounded-xl mb-4">
            <h2 className="font-semibold text-gray-900">{t("dashboardTitle")}</h2>
